  ...
  return (
    <div className="max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center">
      <main>
        ...
        <Image src={avatarImg} alt="Exemplo de Avatar"/>
      ...
      <Image src={appPreviewImg} alt="Dois celulares com prévia da aplicação móvel do NLW Copa" 
      quality={100}/>
    </div>
